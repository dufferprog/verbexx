...
#include <sys/stat.h>
#include <sys/timeb.h>
//#include <sys/types.h>    //   (alrem_allady included, before <sys/stat.h>, as required) 
#include <sys/utime.h>
...
#include <complex>
#ifndef _MANAGED
  #include <condition_variable>      // C++11 -- not supported with /clr option
#endif
#include <deque>
#include <exception>
//#include <execution>               // C++17 -- missing
#include <filesystem>                // C++17 
#include <forward_list>              // C++11
#include <fstream>
#include <functional>
#ifndef _MANAGED
  #include <future>                  // C++11 -- not supported with /clr option
#endif
...
#include <map>
#include <memory>
//#include <memory_resource>         // C++17 -- missing
#ifndef _MANAGED
  #include <mutex>                   // C++11 -- not supported with /clr option
#endif
#include <new>
#include <numeric>
...
#include <set>
#ifndef _MANAGED
  #include <shared_mutex>            // C++14 -- not supported with /clr option
#endif
#include <sstream>
#include <stack>
#include <stdexcept>
...
#ifndef _MANAGED
  #include <thread>                  // C++11 -- not supported with /clr option
#endif
#include <tuple>                     // C++11
...
#pragma message("???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????")
#pragma message("???????????????????????????????????                                            ????????????????????????????????????????????????????????????????????????????????????????????????????")
#pragma message("???????????????????????????????????  Temporary define of std::unary_function   ????????????????????????????????????????????????????????????????????????????????????????????????????")
#pragma message("???????????????????????????????????  Temporary define of std::binary_function  ????????????????????????????????????????????????????????????????????????????????????????????????????")
#pragma message("???????????????????????????????????                                            ????????????????????????????????????????????????????????????????????????????????????????????????????")
#pragma message("???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????")
#pragma message("???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????")
#pragma message("???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????")
...
#include <boost/multiprecision/cpp_dec_float.hpp>              // template syntax errors with C++17 -- bug in 1.65.0 1.65.1, but fixed now
#include <boost/multiprecision/cpp_bin_float.hpp>              // template syntax errors with C++17 -- bug in 1.65.0 1.65.1, but fixed now
#include <boost/multiprecision/cpp_int.hpp>                    // template syntax errors with C++17 -- bug in 1.65.0 1.65.1, but fixed now
